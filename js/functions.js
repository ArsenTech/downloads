...
export function downloadFile(o,e){e.src="files/icons/downloading.svg",getDownloadURL(ref(storage,o)).then((o=>{const s=document.createElement("a");s.href=o,s.download="",s.click(),e.src="files/icons/download-done.svg",setTimeout((()=>e.src="files/icons/download.svg"),2e3)})).catch((o=>{e.src="files/icons/error-icon.svg",setTimeout((()=>e.src="files/icons/download.svg"),2e3);console.error(o)}))}
