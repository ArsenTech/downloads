...
cards.forEach(card=>{const files = card.dataset.filePath,i = card.dataset.index, url = card.dataset.url;if(files) getFileInfo(files,i);if(url) getFileInfoURL(url,i);})
