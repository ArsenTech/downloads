export const downloads = [
     {style: "background: url(./files/card-img/windows/win3.1.webp) center; background-size: cover;",title: "Windows 3.1",filePath: "windows/Win3.1.ISO",category: "windows",},
     {style: "background: url(./files/card-img/windows/win7.webp) center;  background-size: cover;",title: "Windows 7",filePath: "windows/Win7.iso",category: "windows",},
     {style: "background: url(./files/card-img/windows/win8.webp) center; background-size: cover;",title: "Windows 8",filePath: "windows/Win8.iso",category: "windows",},
     {style: "background: url(./files/card-img/windows/win10.webp) center; background-size: cover;",title: "Windows 10",filePath: "windows/Win10.iso",category: "windows",},
     {style: "background: url(./files/card-img/windows/win11.webp) center; background-size: cover;",title: "Windows 11",filePath: "windows/Win11.ISO",category: "windows",},
     ...
     {style: "background: url(./files/card-img/windows/winvista.webp) center; background-size: cover;",title: "Windows Vista",filePath: "windows/WinVista.iso",category: "windows",},
     ...
     {style: "background: url(./files/card-img/ms-dos.webp) center; background-size: cover;",title: "MS-DOS v7.10",filePath: "ms-dos/MS-DOS_7.10.iso",category: "ms-dos",},
